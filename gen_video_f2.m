...
docname1 = strcat('data/output_csv/', docname);
...
prepare_video( docname, viewangle, x, y, z, numframes, x2, y2, z2);
end
...
function prepare_video( video_name, viewangle, x, y, z, numframes, x2, y2, z2)
%UNTITLED 此处显示有关此函数的摘要
%   此处显示详细说明
% Prepare video
fig1 = figure(1);
